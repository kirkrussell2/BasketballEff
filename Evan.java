public class Evan implements Weighting
{
     ...
     static double ftmiss = 2;
     static double rebounds = 3;
     ...
     public static double Evandefensive()
    {
    ...
    public static double Evanoffensive()
    {
            double ftper = (ftmade/ftmiss); 
            double made = (pt3made + pt2made);
            double miss = (pt3miss + pt2miss); 
    ...
    public static double Evanbalanced()
    {
            double ftper = (ftmade/ftmiss); 
            double made = (pt3made + pt2made);
            double miss = (pt3miss + pt2miss); 
