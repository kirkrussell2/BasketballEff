public class Costick implements Weighting
{
     static double pt2made = 1;
     static double pt2miss = 6;
     static double pt3made = 0;
     static double pt3miss = 0;
     static double ftmade = 0;
     static double ftmiss = 1;
     static double rebounds = 12;
     static double assist = 1;
     ...
     public static double Costickdefensive()
    {
    ...
    public static double Costickoffensive()
    {
            double ftper = (ftmade/ftmiss); 
            double made = (pt3made + pt2made);
            double miss = (pt3miss + pt2miss); 
    ...
    public static double Costickbalanced()
    {
            double ftper = (ftmade/ftmiss); 
            double made = (pt3made + pt2made);
            double miss = (pt3miss + pt2miss); 
