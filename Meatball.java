public class Meatball implements Weighting
{
     static double pt3made = 0;
     static double pt3miss = 0;
     static double pt2made = 2;
     static double pt2miss = 7;
     static double ftmade = 0;
     static double ftmiss = 0;
     static double rebounds = 2;
     static double assist = 0;
     static double steal = 1; 
     ...
     public static double Meatballdefensive()
    {
    ...
    public static double Meatballoffensive()
    {
            double ftper = (ftmade/ftmiss); 
            double made = (pt3made + pt2made);
            double miss = (pt3miss + pt2miss); 
    ...
    public static double Meatballbalanced()
    {
            double ftper = (ftmade/ftmiss); 
            double made = (pt3made + pt2made);
            double miss = (pt3miss + pt2miss); 
