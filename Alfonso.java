public class Alfonso implements Weighting
{
     ...
     public static double Alfansodefensive()
    {
    ...
    public static double Alfonsooffensive()
    {
            double ftper = (ftmade/ftmiss); 
            double made = (pt3made + pt2made);
            double miss = (pt3miss + pt2miss); 
    ...
    public static double Alfonsobalanced()
    {
            double ftper = (ftmade/ftmiss); 
            double made = (pt3made + pt2made);
            double miss = (pt3miss + pt2miss); 
