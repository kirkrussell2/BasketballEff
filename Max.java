public class Max implements Weighting
{
     static double pt2made = 24;
     static double pt2miss = 59;
     static double pt3made = 26;
     static double pt3miss = 89;
     static double ftmade = 8;
     static double ftmiss = 12;
     static double rebounds = 45;
     static double assist = 12;
     static double steal = 13; 
     static double block = 0;
     static double turnover = 27;
     static double charge = 0;
     static double fouls = 8;
     static double pt = 179;
     static double plmin = 1; 
     public static double Maxdefensive()
    {
    ...
    public static double Maxoffensive()
    {
            double ftper = (ftmade/ftmiss); 
            double made = (pt3made + pt2made);
            double miss = (pt3miss + pt2miss); 
    ...
    public static double Maxbalanced()
    {
            double ftper = (ftmade/ftmiss); 
            double made = (pt3made + pt2made);
            double miss = (pt3miss + pt2miss); 
